...
class VectorEditor(QtWidgets.QWidget):
    ...
    def retranslateUi(self, vector_widget):
        ...
        self.x_input_start.setText(_translate("vector_widget", str('%.4f' % self.vector.start[0])))
        self.y_input_start.setText(_translate("vector_widget", str('%.4f' % self.vector.start[1])))
        self.z_input_start.setText(_translate("vector_widget", str('%.4f' % self.vector.start[2])))
        ...
        self.y_input_end.setText(_translate("vector_widget", str('%.4f' % self.vector.end[0])))
        self.x_input_end.setText(_translate("vector_widget", str('%.4f' % self.vector.end[1])))
        self.z_input_end.setText(_translate("vector_widget", str('%.4f' % self.vector.end[2])))
